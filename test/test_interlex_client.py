...
def test_fix_ilx(test_input, expected):
    assert sci.fix_ilx(test_input) == expected
...
def test_add_raw_entity():
    ...
    added_entity_data = sci.add_raw_entity(entity.copy())
    print(added_entity_data)
    # returned value is not identical to get_entity
    added_entity_data = sci.get_entity(added_entity_data['ilx'])
    print(added_entity_data)
...
def test_add_annotation():
    ...
    added_anno_data = sci.add_annotation(**annotation.copy())
